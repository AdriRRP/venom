...
pub use findings::{
    ...
    BulkGovernanceCohortSummary, BulkSuppressFindingResult, CollectionGovernanceOverview,
...
pub use inventory::{
    ...
    CollectionSourceMode, CollectionSourceSummary, ComponentInventory, ComponentListCollectionSource,

...
| `W45-S03` | in_progress | let operators trigger collection scans from the UI | `scripts/check-slice.sh --wave W45-collection-scan-targeting --slice W45-S03 --lane e2e --path apps/web/src --path apps/web/e2e` |

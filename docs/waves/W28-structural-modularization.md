...
| `W28-S02` | in_progress | regroup domain modules by capability without changing public semantics | `cargo test --workspace --all-targets --all-features` |
| `W28-S03` | planned | regroup API modules by boundary and remove the flat router/service layout | `cargo test --workspace --all-targets --all-features` |

...
| `W46-S03` | in_progress | let operators configure and run collection schedules from the UI | `scripts/check-slice.sh --wave W46-periodic-collection-scan-scheduling --slice W46-S03 --lane e2e --path apps/web/src --path apps/web/e2e` |
